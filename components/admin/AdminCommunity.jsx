...
import { MOCK_COMMUNITY_STRUCTURE } from '../../utils/adminData';

const AdminCommunity = () => {
  const [communities, setCommunities] = useState(MOCK_COMMUNITY_STRUCTURE);
  const [expandedId, setExpandedId] = useState('hindu');
  const [selectedCaste, setSelectedCaste] = useState(null);
  
  // Theme Preview State
  const [activePreview, setActivePreview] = useState(communities[0]);
